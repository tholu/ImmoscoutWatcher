...
public class WatcherServiceImpl extends RemoteServiceServlet implements
	...
	public Immobilie[] getImmos(final String[] someParams) {
		 ...
		 * 
		 * // echo int i = 0; for (final Immobilie immobilie : resultsList) {
		 * System.out.println(i++ + " Title = " + immobilie.titleString +
		 * " Kaufpreis = " + immobilie.kaufpreisString + " Wohnfläche = " +
		 * immobilie.wohnflaecheString + " Zimmer = " + immobilie.zimmerString +
		 * "ObjectID = " + immobilie.objectIDString); }
		 * 
		 * final Immobilie[] resultsArray = resultsList .toArray(new
		 * Immobilie[resultsList.size()]);
		 */
